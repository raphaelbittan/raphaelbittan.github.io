---
layout: post
title: GraphQL Understanding
date: 2019-05-03
permalink: /blog/:title:output_ext
categories: [grapql, ruby]
tags: [2019]
comments: true
comment_issue_id: 1
---
...
<div class="paragraph">
  <h1 style="text-align:center;">GraphQL: Union vs. Interface</h1>
  <p>As the world has been moving towards GraphQL for all new services. Acknowledging GraphQL is a relatively new technology, that had me facing some challenging questions as developing most of my recent services.</p>
  <p>Naively as my first attempt to define GraphQL types and schemas, I naturally tried to map our database models to GraphQL types. While this may work for lot of cases, we may not be utilizing some of the useful features that come with GraphQL that can make the consuming our data a lot easier.</p>
</div>
